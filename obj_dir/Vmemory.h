...
VL_MODULE(Vmemory) {
  public:
    ...
    VL_IN8(w_enable,0,0);
    VL_IN8(r_enable,0,0);
    VL_IN(addr_select,31,0);
    VL_IN(data_in,31,0);
    VL_OUT(data_out,31,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    CData/*0:0*/ memory__DOT__w_enable_r;
    CData/*0:0*/ memory__DOT__r_enable_r;
    IData/*31:0*/ memory__DOT__addr_select_r;
    IData/*31:0*/ memory__DOT__data_in_r;
    IData/*31:0*/ memory__DOT__data_out_r;
    IData/*31:0*/ memory__DOT__mem[128];
