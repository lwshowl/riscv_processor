...
VL_INLINE_OPT void Valu::_sequent__TOP__1(Valu__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->rst)))) {
        vlTOPp->alu__DOT__done = 0U;
        if (vlTOPp->alu__DOT__in_valid_r) {
            vlTOPp->alu__DOT__result = ((1U == (IData)(vlTOPp->alu__DOT__op_in_r))
                                         ? (vlTOPp->alu__DOT__a_in_r 
                                            + vlTOPp->alu__DOT__b_in_r)
                                         : ((2U == (IData)(vlTOPp->alu__DOT__op_in_r))
                                             ? ((IData)(1U) 
                                                + (vlTOPp->alu__DOT__a_in_r 
                                                   + 
                                                   (~ vlTOPp->alu__DOT__b_in_r)))
                                             : 0U));
            vlTOPp->alu__DOT__done = 1U;
        } else {
            vlTOPp->alu__DOT__result = 0U;
        }
    }
    vlTOPp->out_valid = vlTOPp->alu__DOT__done;
...
void Valu::_ctor_var_reset() {
    ...
    a_in = VL_RAND_RESET_I(32);
    b_in = VL_RAND_RESET_I(32);
    in_valid = VL_RAND_RESET_I(1);
    out = VL_RAND_RESET_I(32);
    out_valid = VL_RAND_RESET_I(1);
    alu__DOT__a_in_r = VL_RAND_RESET_I(32);
    alu__DOT__b_in_r = VL_RAND_RESET_I(32);
    alu__DOT__in_valid_r = VL_RAND_RESET_I(1);
    alu__DOT__result = VL_RAND_RESET_I(32);
    alu__DOT__op_in_r = VL_RAND_RESET_I(2);
    alu__DOT__done = VL_RAND_RESET_I(1);
